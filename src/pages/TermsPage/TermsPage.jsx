      ...
      <main className="terms-page">
        <div className="terms-content">
          <div className="terms-header">
            <h1 className='italiana-regular'>Terms and Conditions</h1>
          ...
          <div className="terms-section">
            <h2 className='poppins-light'>2. Intellectual Property Rights</h2>
            <p className='poppins-light'>
          ...
          <div className="terms-section">
            <h2 className='poppins-light'>3. Restrictions</h2>
            <p className='poppins-light'>
          ...
          <div className="terms-section">
            <h2 className='poppins-light'>4. No warranties</h2>
            <p className='poppins-light'>
          ...
          <div className="terms-section">
            <h2 className='poppins-light'>5. Limitation of liability</h2>
            <p className='poppins-light'>
          ...
          <div className="terms-section">
            <h2 className='poppins-light'>6. Governing Law & Jurisdiction</h2>
            <p className='poppins-light'>
