  ...
  return (
    <>
      ...
      <div className="cancel-page"> {/* Apply the class */}
        ...
        <p className='cancel-text'>Your payment was not completed. Your cart has not been changed.</p>
        <p className='cancel-text'>If you encountered an issue, please try again or contact support.</p>
